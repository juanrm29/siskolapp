                  ...
                  <div id="amazingslider-wrapper-1" class="m-b-40">
                    <div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
                      <ul class="amazingslider-slides" style="display:none;">
                        <li><a href="{{asset('assets/imgs/product-imgs/a-lightbox.jpg')}}" class="html5lightbox"><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></a> </li>
                        <li><a href="{{asset('assets/imgs/product-imgs/4-lightbox.jpg')}}" class="html5lightbox"><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></a> </li>
                        <li><a href="{{asset('assets/imgs/product-imgs/13-lightbox.jpg')}}" class="html5lightbox"><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></a> </li>
                        <li><a href="{{asset('assets/imgs/product-imgs/19-lightbox.jpg')}}" class="html5lightbox"><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></a> </li>
                      </ul>
                      <ul class="amazingslider-thumbnails" style="display:none;">
                        <li><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></li>
                        <li><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></li>
                        <li><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}" alt="" title="" /></li>
                        <li><img src="{{asset('assets/imgs/product-imgs/pro325x370.png')}}"  alt="" title="" /></li>
                      </ul>
